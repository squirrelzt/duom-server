...
class UnAuditedx extends Component {
    constructor(props) {
        super();
        this.state = {
            data: [],
        ...
        return (
            <div id="audited-container">
              <div className="">
                ...
                />
                <Checkx {...this.props} init={{visible:this.state.checkMoalVisible, data:this.state.checkData,
...
UnAuditedx = Form.create()(UnAuditedx);
export default UnAuditedx;